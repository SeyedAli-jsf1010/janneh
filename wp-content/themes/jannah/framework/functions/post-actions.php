...
if (!function_exists('tie_post_tags')) {
    ...
    {
        if (!is_singular('modernpost' or 'post')) {
            return;
        }
        ...
        if (get_post_type() == 'modernpost') {
            $get_tags = get_the_terms(get_the_id(), 'mpost_tag');
            if (!empty($get_tags)) {

                echo '<div class="post-bottom-meta post-bottom-tags" style="display: inline-block"><div class="post-bottom-meta-title"><span class="fa fa-tags" aria-hidden="true"></span> ' . esc_html__('Tags', TIELABS_TEXTDOMAIN) . '</div></div>';
                foreach ($get_tags as $tage) {

                    echo '<div class="post-bottom-meta post-bottom-tags" style="display: inline-block"><div><span class="tagcloud"><a href="' . get_home_url() . '/mpost_tag/' . $tage->slug . '" rel="tag">' . $tage->name . '</a></span></div></div>';
                }
    ...
    if (!function_exists('tie_read_next_posts')) {
        ...
        function tie_read_next_posts()
        {
            ...
            //
            // displaying next post
            //
            $get_next_post = get_next_post();
            $get_thumbnail_next_post = get_the_post_thumbnail($get_next_post->ID);

            $get_previous_post = get_previous_post();
            $get_thumbnail_previous_post = get_the_post_thumbnail($get_previous_post->ID);
            if (get_post_type() == 'modernpost') {
                ...
                <div class="prev-next-post-nav container-wrapper media-overlay">
                    <?php if ($get_next_post) {
                        echo '<div class="tie-col-xs-6 prev-post">
				<a href="' . $get_next_post->guid . '" class="post-thumb" rel="prev">
					<div class="post-thumb-overlay-wrap">
						<div class="post-thumb-overlay">
						<img src="' . $get_thumbnail_next_post . '">
							<span class="icon"></span>
						</div>
					</div>
				</a>

				<a href="' . $get_next_post->guid . '" rel="prev">
					<h3 class="post-title">' . $get_next_post->post_title . '</h3>
				</a>
			</div>';
                    } ?>
                    <?php
                    if ($get_previous_post) {
                        echo '<div class="tie-col-xs-6 next-post">
				<a href="' . $get_previous_post->guid . '" class="post-thumb" rel="next">
					<div class="post-thumb-overlay-wrap">
						<div class="post-thumb-overlay">
						<img src="' . $get_thumbnail_previous_post . '">
							<span class="icon"></span>
						</div>
					</div>
				</a>

				<a href="' . $get_previous_post->guid . '" rel="next">
					<h3 class="post-title">' . $get_previous_post->post_title . '</h3>
				</a>
			</div>';
                    } ?>
                </div>
<?php
                ...
                */
                if (tie_get_option('related_position') == 'modernpost' or 'post') {
                ...
                */
                ...
                if (!is_singular('post' or 'modernpost')) {
                return;
                }
